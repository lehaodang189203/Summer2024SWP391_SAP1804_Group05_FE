        ...
        <div className='mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8'>
          <div className='sm:flex sm:items-center sm:justify-between pr-16'>
            ...
            <ul className='mt-8 flex gap-6 sm:mt-0'>
              <li>
                <a href='#' rel='noreferrer' target='_blank' className='text-gray-50 transition hover:text-blue-600'>
              ...
              <li>
                <a href='#' rel='noreferrer' target='_blank' className='text-gray-50 transition hover:text-orange'>
              ...
              <li>
                <a href='#' rel='noreferrer' target='_blank' className='text-gray-50 transition hover:text-blue-700'>
              ...
              <li>
                <a href='#' rel='noreferrer' target='_blank' className='text-gray-50 transition hover:opacity-75'>
