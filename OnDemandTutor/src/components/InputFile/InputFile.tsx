  ...
  const [fileName, setFileName] = React.useState<string>(
      ...
      {type === 'file' ? (
        <>
           ...
           <label className={''}>
             <div className='flex'> 
               <div className='p-4 h-20 rounded-s-md cursor-pointer border border-slate-500 hover:bg-slate-400'>Chọn File</div>
               <div className=" bg-slate-400 h-20 w-full rounded-e-md">
