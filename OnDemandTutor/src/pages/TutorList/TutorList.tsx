      ...
      {tutors.map((tutor, index) => (
        ...
        >
          <div className="col-span-12 flex">
            ...
            {/* description */}
            <div className="col-span-5 mx-4 my-5" onClick={() => handleItemClick(tutor)}>
              <div className="w-[45rem] h-full py-2">
                <div className="justify-start flex pl-2">
                  <div>
                    <h1 className="text-2xl text-bold-sm text-start">Tên Gia sư: {tutor.fullname}</h1>
                    {/* gender */}
                    ...
                    <div className="text-lg justify-start flex pl-1 pt-2">
                      ...
                      <span className="pl-2 pt-1">{tutor.qualificationname}</span>
                    </div>
                    {/* study */}
                    <div className="text-lg justify-start flex pl-1 pt-2">
                      <FontAwesomeIcon icon={faUserGraduate} className="pt-2" />
                      <span className="pl-2 pt-1">Kinh nghiệm: {tutor.experience} Năm</span>
                    </div>

                    {/* Description */}
                    <div className="text-lg justify-start flex pl-1 pt-2">
                      <span className="text-start text-sm">{tutor.specializedskills}...</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="col-span-4 w-full h-full">
              <div className="h-full w-full justify-end flex">
                {/*  Trái tim */}
                <div className="mt-2 pr-2" role="button" onClick={handleChangeColor}>
                  <svg
              ...
              <div className="w-full h-full px-auto mx-auto pt-32">
                <div className="rounded-lg w-full h-10 bg-pink-400 hover:opacity-80">
                  <button onClick={()=>handleapproved(tutor)} className="pt-3">
                    Chấp nhận
                  </button>
                </div>
            ...
            <div className="overflow-y-auto p-4">
              ...
              <div className="mx-4 my-5">
                <div className="py-2">
                  <div className="justify-start flex pl-2">
                    <div>
                      <h1 className="text-2xl font-bold text-start">{currentTutor.fullname}</h1>
                      {/* gender */}
                      ...
                      <div className="text-lg flex pl-1 pt-2">
                        <FontAwesomeIcon icon={faUserGraduate} className="pt-2" />
                        <span className="pl-2 pt-1">{currentTutor.qualificationname}</span>
                      </div>
                      {/* Description */}
                      <div className="pt-2 text-left">{currentTutor.qualificationname}</div>
                    </div>
                  </div>
                </div>
              </div>
