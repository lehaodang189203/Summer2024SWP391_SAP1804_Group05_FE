...
export default function ModViewComplaint() {
  ...
  const [selectedRecord, setSelectedRecord] = useState<complaintType | null>(
    null
  )
                ...
                <div className='flex justify-between mb-4'>
                  ...
                  <div>
                    ...
                    <p className='font-semibold mb-1'>
                      Email:{' '}
                      <span className='font-normal text-gray-700'>
                        {selectedRecord.tutor.email}
                      </span>
                    </p>
                    <p className='font-semibold mb-1'>
                      Giới tính:{' '}
                      <span className='font-normal text-gray-700'>
                        {selectedRecord.tutor.gender}
                      </span>
                    </p>
                    <p className='font-semibold mb-1'>
                      Số điện thoại:{' '}
                      <span className='font-normal text-gray-700'>
                        {selectedRecord.tutor.phone}
                      </span>
                    </p>
                  </div>
                </div>
